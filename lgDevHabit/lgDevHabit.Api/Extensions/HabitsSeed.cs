...
public static class HabitsSeed
{
    public static void ApplyHabitsSeed(this WebApplication app)
    {
        ...
        try
        {
            if (!context.Habits.Any())
            {
                ...
                app.Logger.LogInformation("Habit Seed applied successfully.");
            }
        }
        catch (Exception e)
        {
            app.Logger.LogError(e, "An error occurred while seeding database migrations.");
            throw;
        }
    }
