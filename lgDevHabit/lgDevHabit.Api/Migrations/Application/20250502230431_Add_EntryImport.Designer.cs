...
namespace lgDevHabit.Api.Migrations.Application
{
    ...
    [Migration("20250502230431_Add_EntryImport")]
    partial class Add_EntryImport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("lgDevHabit.Api.Entities.Entry", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                    ...
                    b.ToTable("entries", "lgdev_habit");
                });

            modelBuilder.Entity("lgDevHabit.Api.Entities.EntryImportJob", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                    ...
                    b.ToTable("entry_import_jobs", "lgdev_habit");
                });

            modelBuilder.Entity("lgDevHabit.Api.Entities.GitHubAccessToken", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                    ...
                    b.ToTable("git_hub_access_tokens", "lgdev_habit");
                });
            ...
            modelBuilder.Entity("lgDevHabit.Api.Entities.Entry", b =>
                {
                    b.HasOne("lgDevHabit.Api.Entities.Habit", "Habit")
                        .WithMany()
                    ...
                    b.HasOne("lgDevHabit.Api.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("lgDevHabit.Api.Entities.GitHubAccessToken", b =>
                {
                    b.HasOne("lgDevHabit.Api.Entities.User", null)
                        .WithOne()
                        .HasForeignKey("lgDevHabit.Api.Entities.GitHubAccessToken", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
